...
import { ToastrService } from 'ngx-toastr';//notifications
...
export class LoginComponent implements OnInit {
  ...
  submittedl = false;
  submittedr = false;
  emailPattern = "^[a-z0-9._%+-]+@sagem+\.[a-z]{2,4}$";
  ...
  onSubmitl() {
    console.log(this.loginForm.value);
      ...
      this.router.navigate(['compte/accueil']);
          ...
          this.toastr.error('Votre compte est encore desactive', 'Notification');
